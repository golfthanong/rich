    ...
    return Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Icon(Icons.phone), // Add the phone icon here
          ),
          style: TextStyle(
            color: AppColors.primaryText,
            fontFamily: "Avenir",
    ...
    return Container(
      ...
      child: InternationalPhoneNumberInput(
        onInputChanged: (PhoneNumber number) {
          // You can access the parsed phone number using `number`
          // For example, you can print the parsed number as follows:
          controller.state.email.value = number.phoneNumber!;
          print(number.phoneNumber); // This is the parsed phone number
        },
        ...
        initialValue: PhoneNumber(isoCode: 'TH'), // Set the initial country code if needed
